        ...
        <>
            <Card className="max-w-96">
                ...
                <CardBody>
                    ...
                    className="font-normal opacity-75"
                    >
                    Personal web portfolio site. Created with React.js and Vite. This is where I showcase my work and share my experiences in the world of web development.
                    </Typography>
                </CardBody>
                <CardFooter className="pt-0">
                    <div>
                        <a 
                        href="https://github.com/fiqto/portfolio-react-vite"
                        target="_blank" rel="noreferrer"
                        >
                            <Button
                            ripple={false}
